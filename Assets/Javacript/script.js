// This will update time on the website, set the time in the header and set color states for past, present and future blocks
function updateTime() {
    let today = moment();
  ...
  // here we define the text area variables 
  ...
  // this function determines how to handle form submissions 
